# Script para generar el manual PDF de manejo de plagas y enfermedades de badea con QR y branding MELANT IA
...
def generar_pdf():
    ...
    qr_path = "manual_manejo_plagas_enfermedades_badea_qr.png"
    qr.save(qr_path)
    # Crear PDF
    pdf = PDF()
    pdf.title = TITULO
    ...
    pdf.output("manual_manejo_plagas_enfermedades_badea.pdf")
    print("PDF generado: manual_manejo_plagas_enfermedades_badea.pdf")
