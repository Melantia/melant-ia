import {
  ...
  modoCampo,
  cargarVoz,
  conectarEstructuraAIndex,
  mostrarDatosOCDS,
  abrirModulo,
} from './modules/ui_helpers.js';

// Amarrar al objeto global window para que los HTML antiguos no se queden ciegos
window.gestionarEstadoOffline = gestionarEstadoOffline;
window.ui_melantia = ui_melantia;
window.modoCampo = modoCampo;
window.cargarVoz = cargarVoz;
window.conectarEstructuraAIndex = conectarEstructuraAIndex;
window.mostrarDatosOCDS = mostrarDatosOCDS;
