// proyectos_hub.js — HUB de Proyectos MELANTIA
// Este archivo centraliza el acceso a los submódulos de proyectos

const SUBMODULOS = [
  {
    nombre: 'Proyecto Captura de Carbono',
    archivo: './proyecto_captura_carbono.js',
  },
  {
    nombre: 'Proyecto Saberes Ancestrales y Folklore',
    archivo: './proyecto_saberes_ancestrales.js',
  },
  {
    nombre: 'El Tesoro de los Abuelos (Memoria Viva)',
    archivo: './tesoro_abuelos.js',
  },
  {
    nombre: 'Herbario Memoria Cultural',
    archivo: './herbario_memoria_cultural.js',
  },
];
...
export function mostrarPanel() {
  ...
  cont.innerHTML = `
    <div class="panel-hub" style="max-width:700px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style='color:#276749;text-align:center;margin-bottom:24px;'>Proyectos</h2>
