# Script para generar los manuales PDF de maracuyá desde a_maracuya.json con QR y branding MELANT IA
...
def main():
    with open("a_maracuya.json", encoding="utf-8") as f:
        data = json.load(f)
    # Manual regenerativo
    mr = data["manual_regenerativo"]
    generar_pdf(mr["titulo"], mr["contenido"], mr["qr_link"], "manual_maracuya_regenerativo.pdf")
    # Manual químico
    mq = data["manual_quimico"]
    generar_pdf(mq["titulo"], mq["contenido"], mq["qr_link"], "manual_maracuya_quimico.pdf")
