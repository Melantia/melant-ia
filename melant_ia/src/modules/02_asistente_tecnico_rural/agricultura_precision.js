...
// Panel base para Agricultura de Precisión (Sensores)
...
export function mostrarPanel() {
  ...
  contenedor.innerHTML = `
    <div class="panel-especifico" style="max-width:600px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style="color:#276749;">Agricultura de Precisión (Sensores)</h2>
      <p style="color:#444;font-size:1.1em;">Aquí puedes consultar herramientas y datos de agricultura de precisión y sensores.</p>
