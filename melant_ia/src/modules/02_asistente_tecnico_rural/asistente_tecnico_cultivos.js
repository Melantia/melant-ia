...
// Panel base para Asistente Técnico en Cultivos
...
export function mostrarPanel() {
  ...
  contenedor.innerHTML = `
    <div class="panel-especifico" style="max-width:600px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      ...
      <p style="color:#444;font-size:1.1em;">Aquí puedes consultar información y herramientas para el manejo técnico de cultivos.</p>
