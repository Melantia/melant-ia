// servicios_financieros_hub.js — HUB de Servicios Financieros Melantia
// Este archivo centraliza el acceso a los submódulos de servicios financieros

const SUBMODULOS = [
  {
    nombre: 'Apertura de Cuenta Digital',
    archivo: './apertura_cuenta_digital.js',
  },
  { nombre: 'Onboarding y Validación KYC', archivo: './onboarding_kyc.js' },
  {
    nombre: 'Gestión de Pagos y Beneficios',
    archivo: './gestion_pagos_beneficios.js',
  },
  {
    nombre: 'Simulación de Perfil Financiero',
    archivo: './simulacion_perfil_financiero.js',
  },
  { nombre: 'Solicitar Microcrédito', archivo: './solicitar_microcredito.js' },
  {
    nombre: 'Transferencias y Movimientos',
    archivo: './transferencias_movimientos.js',
  },
  {
    nombre: 'Integración con Bancos y Cooperativas',
    archivo: './integracion_bancos.js',
  },
  {
    nombre: 'Historial y Estado de Cuenta',
    archivo: './historial_estado_cuenta.js',
  },
];
...
export function mostrarPanel() {
  ...
  cont.innerHTML = `
    <div class="panel-hub" style="max-width:700px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style='color:#276749;text-align:center;margin-bottom:24px;'>Servicios Financieros Melantia</h2>
