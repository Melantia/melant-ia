// comunidad_virtual_hub.js — HUB de Mi Comunidad Virtual MELANTIA
// Este archivo centraliza el acceso a los submódulos de la comunidad virtual

const SUBMODULOS = [
  { nombre: 'Ciudadano Rural', archivo: './ciudadano_rural.js' },
  { nombre: 'Asesoría Legal', archivo: './asesoria_legal.js' },
  { nombre: 'Walkie Talkie', archivo: './walkie_talkie.js' },
];
...
export function mostrarPanel() {
  ...
  cont.innerHTML = `
    <div class="panel-hub" style="max-width:700px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style='color:#276749;text-align:center;margin-bottom:24px;'>Mi Comunidad Virtual</h2>
