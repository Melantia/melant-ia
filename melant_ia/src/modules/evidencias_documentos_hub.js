// evidencias_documentos_hub.js — HUB de Registro Evidencias y Documentos MELANTIA
// Este archivo centraliza el acceso a los submódulos de evidencias y documentos

const SUBMODULOS = [
  {
    nombre: '🗂️ Registro de Evidencia Fotográfica',
    archivo: './registro_evidencia_fotografica.js',
  },
  {
    nombre: '📄 Carpeta Documentos',
    archivo: './carpeta_documentos.js',
  },
  {
    nombre: '📦 Descargar, Compartir e Imprimir',
    archivo: './descargar_compartir_imprimir.js',
  },
];
...
export function mostrarPanel() {
  ...
  cont.innerHTML = `
    <div class="panel-hub" style="max-width:700px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style='color:#276749;text-align:center;margin-bottom:24px;'>Evidencias y Documentos</h2>
