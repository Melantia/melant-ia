// finanzas_personales_hub.js — HUB de Finanzas Personales MELANTIA
// Este archivo centraliza el acceso a los submódulos de finanzas personales

const SUBMODULOS = [
  {
    nombre: '💰 Registro Financiero Inteligente',
    archivo: './registro_financiero_inteligente.js',
  },
  {
    nombre: '⚠️ Consejos y Alertas',
    archivo: './consejos_alertas.js',
  },
  {
    nombre: '💰 Termómetro Financiero',
    archivo: './termometro_financiero.js',
  },
  {
    nombre: '📦 Gráfica de Ingresos y Gastos',
    archivo: './grafica_ingresos_gastos.js',
  },
];
...
export function mostrarPanel() {
  ...
  cont.innerHTML = `
    <div class="panel-hub" style="max-width:700px;margin:40px auto;background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(0,0,0,0.10);padding:32px 24px;">
      <h2 style='color:#276749;text-align:center;margin-bottom:24px;'>Finanzas Personales</h2>
